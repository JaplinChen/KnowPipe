...
const cases = [
  { title: 'Claude Code 完整教學', body: '', expected: 'AI/工具', note: '品牌名稱' },
  { title: 'Prompt Engineering 入門', body: '', expected: 'AI/提示詞', note: 'Prompt 相關' },
  { title: 'DeepSeek vs GPT-4o 評測', body: '', expected: 'AI/模型', note: '模型評測' },
  { title: '如何用 Python 寫 API', body: '', expected: '程式設計', note: '純程式設計' },
  { title: '今日股市分析 ETF 配置', body: '', expected: '投資理財', note: '投資' },
  { title: 'Obsidian 筆記工作流', body: '', expected: '生產力', note: 'PKM' },
  { title: '我用了三個月的學習心得', body: '完全不提 AI', expected: '其他', note: '不應觸發' },
  { title: '旅遊日記', body: '去了 Apple 農場', expected: '生活', note: 'Apple 不觸發科技' },
  { title: '人工智慧時代的職場焦慮', body: '', expected: 'AI', note: '繁中 AI' },
  { title: '機器學習入門完全指南', body: '', expected: 'AI', note: '機器學習→AI' },
];
...
for (const c of cases) {
  ...
  console.log(\`| \${c.title.slice(0,30)} | \${c.expected} | \${actual} | \${ok ? '✅' : '❌'} | \${c.note} |\`);
}
...
| GitHub | `https://github.com/anthropics/claude-code` | title 含 'claude' |
