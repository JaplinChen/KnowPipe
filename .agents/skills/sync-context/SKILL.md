---
title: sync-context
description: 掃描程式碼庫，自動同步 AGENTS.md 的專案狀態區段 + 匯出跨工具 context
---
...
## 使用方式
```
/sync-context              # 同步 AGENTS.md 自動區段
/sync-context --all        # 同步 AGENTS.md + .cursorrules + 顯示 system prompt
...
- 不觸碰 AGENTS.md 手動維護的 Hard Rules / Guidelines 區段
- 首次執行時自動在檔案末尾附加標記區段
