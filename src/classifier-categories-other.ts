/** 非 AI 分類規則（知識管理、科技、生活等） */
import type { CategoryRule } from './classifier-categories.js';

export const OTHER_CATEGORIES: CategoryRule[] = [
  {
    name: '知識管理/Obsidian',
    keywords: [
      ...
      'personal-knowledge', 'roam', 'logseq', 'siyuan', '思源', '知識管理', '知识管理',
    ],
  },
  { name: 'macOS 生態/oMLX', keywords: ['omlx', 'mlx', 'apple silicon model', 'local llm mac'] },
  {
    name: 'macOS 生態',
    keywords: [
  ...
  },
  {
    ...
    keywords: [
      ...
      'revenue', 'mrr', 'arr', 'b2b', '創業', '創辦人', '商業', '商業模式', 'business', 'entrepreneur', '產品',
    ],
  },
  ...
  { name: '中文媒體', keywords: ['微博', 'weibo', '小紅書', '小红书', 'xiaohongshu', '紅書', 'xhs', 'bilibili', 'b站', '嗶哩嗶哩', '哔哩哔哩', '抖音', 'douyin', '今日頭條', '今日头条', 'toutiao', 'tiktok', '知乎', 'zhihu', '豆瓣', 'douban'] },
  {
    name: '生產力',
    keywords: [
      'productivity', 'habit', 'focus', '生產力', '工作流', '效率', 'notion', 'syncthing',
      '檔案同步', '磁盤清理', '系統優化', 'dotfiles', 'ricing', 'desktop-customization', 'rice',
  ...
  {
    name: '生活',
    keywords: ['food', 'travel', 'health', 'fitness', 'workout', 'recipe', 'book', 'movie', '飲食', '旅遊', '健康', '運動', '閱讀', '電影', '生活', 'lifestyle'],
    exclude: ['github', 'cli', 'api', 'heartbeat', '健康檢查', 'health check', 'docker', '開源', 'open source', 'sdk', 'npm', 'bot'],
  },
  ...
  // ── 知識管理子分類 ──
  {
    ...
    keywords: [
      ...
      'spaced repetition', '間隔重複', 'anki', 'note-taking method', 'moc', 'map of content', '主題地圖',
    ],
  },
  {
    name: '知識管理/Obsidian 設定',
    keywords: ['obsidian 設定', 'obsidian config', 'obsidian theme', 'obsidian vault', 'obsidian 主題', 'obsidian 配置', 'obsidian css', 'obsidian snippets'],
  },
  {
    name: '知識管理/Obsidian 插件',
    keywords: ['obsidian plugin', 'obsidian 插件', 'obsidian 外掛', 'dataview', 'templater', 'excalidraw', 'kanban', 'community plugin'],
  },
